...
export type CapabilityMaturity="UNAVAILABLE"|"EXPERIMENTAL"|"PRODUCTION";
export type ProviderCapabilities={textToMusic:boolean;lyrics:boolean;referenceAudio:boolean;continuation:boolean;repaint:boolean;stems:boolean;nativeMultitrack:boolean;contextualRegeneration:CapabilityMaturity;sourceSeparation:CapabilityMaturity;bpmControl:boolean;keyControl:boolean;seed:boolean};
